...
these middleware are called at each request, and then either they pass the control to the next middleware or just end the request response cycle.
...
Let's say we want to visit a rout /secret only when a particular 'passowrd' query is sent.

like -> if password is '1234', then only /secret should be 
